// Pozn. Oficiální řešení poskytnuté lektorem:
...
it was the grayish white of old porridge.";
		...
		// string oddelovac = string.Empty.PadLeft(20, '-');
		...
		string jmeno1 = "Katka";
		string jmeno2 = "katka";
		bool jeStejne = string.Compare(jmeno1, jmeno2, StringComparison.InvariantCultureIgnoreCase) == 0;
		//bool jeStejne = jmeno1.Equals(jmeno2, StringComparison.InvariantCultureIgnoreCase);
		...
		// bool piseSeOMarge = text.IndexOf("Marge") >= 0;
		...
		string veta = text.Split(new char[] { '!', '"' }, StringSplitOptions.RemoveEmptyEntries)[0];
